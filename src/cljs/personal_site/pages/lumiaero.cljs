...
(defn html []
  (project-page/template
   ...
   ["0:00 - Intro" "0:42 - Technologies Used" "1:05 - User Management" "3:10 - Aircraft Management" "6:42 - Subcategory Management" "8:22 - Excel Operations" "15:01 - Brief API Overview"]
   nil
   nil
