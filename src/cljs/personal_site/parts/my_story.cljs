  ...
  [:div {:id "myStory"}
   [:div {:class "infoContainer"}
    ...
    [:div {:class "storyContainer"}
     ...
     [:span {:class "storyEntry"} "After college, I spent three years as a " [:a {:class "highlighted" :href "https://twitch.tv"} "Twitch"] " streamer. I no longer stream on Twitch, but I develop apps for streamers as freelance work in my free time."]
